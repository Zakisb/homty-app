		...
		<div className={className}>
			...
			<div className="mt-3 relative">
				...
				<input
					...
					name={name}
					className={cn(
						icon ? 'pl-10' : '', 'w-full text-brand-secondary rounded-md border border-gray-300 bg-white py-2  pr-8 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 text-sm'
					)}
					disabled={disabled}
					autoComplete="off"
					autoCorrect="off"
