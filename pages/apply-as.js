...
export default function ApplyAs () {
	...
	return (<div className="flex pt-36 justify-center">
			{/*<Card className="md:max-w-2xl w-10/12 md:px-16 md:py-12">
                ...
                <div className="px-16"><Button title={activeIndex ? applyType.find((e) => e.id === activeIndex).cta : 'Create account'} disabled={!activeIndex} onClick={(e) => console.log(e)}/></div>
