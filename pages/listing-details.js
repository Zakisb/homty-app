					...
					<div className="mt-4 bg-white  border border-solid border-[#e2e2e2] rounded-md">
						<div className=" py-10 px-4 sm:px-6 lg:px-8 lg:py-14">
							<div className="relative mx-auto max-w-xl">
								...
								<div className="mt-12">
									<div className="mb-4"><h4 className="inline mr-2">650€</h4>
										<span className="text-gray-400">/month</span></div>
                      ...
                      />
                        ...
                        <CheckIcon className="h-5 w-5" aria-hidden="true" />
										...
										<AppCombobox selectedValue={selectedValue}
